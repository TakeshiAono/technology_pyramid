...
class TechnologiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create technology" do
    assert_difference('Technology.count') do
      post technologies_url, params: { technology: { lower_technology: @technology.lower_technology, name: @technology.name, public_flag: @technology.public_flag, upper_technology: @technology.upper_technology, pyramid_id: @technology.pyramid_id } }
    end
  ...
  test "should update technology" do
    patch technology_url(@technology), params: { technology: { lower_technology: @technology.lower_technology, name: @technology.name, public_flag: @technology.public_flag, upper_technology: @technology.upper_technology, pyramid_id: @technology.pyramid_id } }
